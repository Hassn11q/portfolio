...
export const metadata: Metadata = {
  ...
  description: `السيرة الذاتية لـ${c.name}، ${c.role}.`,
  alternates: { canonical: "/ar/cv", languages: { en: "/cv", ar: "/ar/cv" } },
};
  ...
  return (
    <>
      <div className="no-print shell flex flex-wrap items-center justify-between gap-4 py-8">
        <Link href="/ar" className="link inline-flex items-center gap-2 text-[0.9375rem]">
